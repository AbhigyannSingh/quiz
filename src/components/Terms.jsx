        ...
        <div id="terms" onClick={handleOutsideClick}>
            <div id="content">
                ...
                <>
                    ...
                    <h4>Installation</h4>
                    <ol>
                        <li>Clone or download the Flashcard Quiz repository from <a rel="noreferrer" href="https://github.com/AbhigyannSingh/quiz" target={'_blank'}>GitHub</a>
                        </li>
                    ...
                    <h4>Live Demo</h4>
                    <p>Check out the live version of the project <a rel="noreferrer" href="https://quizquiz-puce.vercel.app/" target={'_blank'}>here</a></p>
